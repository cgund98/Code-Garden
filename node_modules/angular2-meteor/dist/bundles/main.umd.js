(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.meteor = {}),global.ng.meteor.polyfills,global.underscore,global.ng.core));
}(this, (function (exports,angular2MeteorPolyfills,_,core) { 'use strict';
 ...
 */
var ZoneRunScheduler = /** @class */ (function () {
...
'use strict';
var CursorHandle = /** @class */ (function () {
...
var UpdateChange = /** @class */ (function () {
 ...
 */
var MongoCursorObserver = /** @class */ (function (_super) {
...
var IterableChangeRecord = /** @class */ (function () {
    function IterableChangeRecord(item, trackById) {
        this.item = item;
    ...
    IterableChangeRecord.prototype.toString = function () {
        return this.previousIndex === this.currentIndex ? stringify(this.item) :
            stringify(this.item) + '[' +
                stringify(this.previousIndex) + '->' + stringify(this.currentIndex) + ']';
    };
    return IterableChangeRecord;
}());
...
var MongoCursorObserverFactory = /** @class */ (function () {
...
var MongoCursorDifferFactory = /** @class */ (function () {
    function MongoCursorDifferFactory() {
    }
    MongoCursorDifferFactory.prototype.supports = function (obj) { return checkIfMongoCursor(obj); };
    MongoCursorDifferFactory.prototype.create = function (_cdrOrTrackBy) {
        return new MongoCursorDiffer(_cdrOrTrackBy, new MongoCursorObserverFactory());
    };
    return MongoCursorDifferFactory;
}());
var trackByIdentity = function (index, item) { return item._id; };
/**
 ...
 */
var MongoCursorDiffer = /** @class */ (function (_super) {
    __extends(MongoCursorDiffer, _super);
    function MongoCursorDiffer(_cdr, obsFactory) {
        var _this = _super.call(this, trackByIdentity) || this;
        _this._inserted = [];
        _this._removed = [];
        _this._moved = [];
        _this._updated = [];
 ...
 */
var MeteorReactive = /** @class */ (function () {
...
var DefaultIterableDifferFactory = /** @class */ (function () {
    ...
    DefaultIterableDifferFactory.prototype.create = function (_cdr, trackByFn) {
        return new core.DefaultIterableDiffer(trackByFn);
    };
...
function meteorProviders() {
    return [
        {
            provide: core.IterableDiffers,
            useFactory: function () { return new core.IterableDiffers([
